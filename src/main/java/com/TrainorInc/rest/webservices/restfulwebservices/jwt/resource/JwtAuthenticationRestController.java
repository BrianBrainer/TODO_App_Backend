package com.TrainorInc.rest.webservices.restfulwebservices.jwt.resource;

import java.util.Objects;

import javax.servlet.http.HttpServletRequest;

import com.TrainorInc.rest.webservices.restfulwebservices.jwt.*;
...
public class JwtAuthenticationRestController {
    ...
    Logger logger = LoggerFactory.getLogger(JwtAuthenticationRestController.class);
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtTokenRequest authenticationRequest)
        ...
        //authenticationRequest.setPassword("$2a$10$4IU2yRL45iouKT986Zfxb.9RQslJ3sg9anp0cuN4ccmeYUYAJaZvO");
    ...
    public ResponseEntity<?> refreshAndGetAuthenticationToken(HttpServletRequest request) {
        ...
        UserEntity userEntity = (UserEntity) jwtInMemoryUserDetailsService.loadUserByUsername(username);
